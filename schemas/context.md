...
System_Ext(api, "Third-Party API", "Внешнее API датчиков отопления", "Uses REST API, JSON data format", $tags="backendContainer")
SystemDb(DB, "База данных", "База с данными пользователей и датчиков")
